...
public class DefaultResolvedVariantSet implements ResolvedVariantSet {
    ...
    public DefaultResolvedVariantSet(ComponentIdentifier componentIdentifier, ImmutableAttributesSchema schema, ImmutableAttributes selectionAttributes, ImmutableSet<ResolvedVariant> variants) {
