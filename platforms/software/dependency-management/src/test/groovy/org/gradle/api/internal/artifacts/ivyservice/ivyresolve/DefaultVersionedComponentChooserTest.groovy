...
class DefaultVersionedComponentChooserTest extends Specification {
    ...
    AttributeSchemaServiceFactory schemaServices = AttributeTestUtil.serviceFactory()
    ComponentSelectionRulesInternal componentSelectionRules = Mock(ComponentSelectionRulesInternal)
    ...
    def chooser = new DefaultVersionedComponentChooser(versionComparator, versionParser, schemaServices, componentSelectionRules, ImmutableAttributesSchema.EMPTY)
