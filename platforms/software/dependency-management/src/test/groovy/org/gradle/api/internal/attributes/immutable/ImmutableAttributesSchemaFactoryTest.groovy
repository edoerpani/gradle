...
class ImmutableAttributesSchemaFactoryTest extends Specification {
    ...
    def "merging creates schema with additional attributes defined by producer"() {
        ...
        def selectionSchema = new DefaultAttributeSelectionSchema(merged)
        ...
        selectionSchema.hasAttribute(attr1)
        selectionSchema.hasAttribute(attr2)
        selectionSchema.hasAttribute(attr3)
    }
